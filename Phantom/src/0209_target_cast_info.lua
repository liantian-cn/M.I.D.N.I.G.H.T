...
分类：      目标状态
分类索引：  9、10
位置：      7行41列、7行42列、5行35列图标

说明

显示目标施法或引导进度、可中断状态和当前施法图标。潜在secret的纹理、持续时间对象和可中断标记直接交给允许secret参数的显示或求值API。
...
local PROGRESS_CELL_POSITION_X = 41
local PROGRESS_CELL_POSITION_Y = 7
local INTERRUPTIBLE_CELL_POSITION_X = 42
local INTERRUPTIBLE_CELL_POSITION_Y = 7
local ICON_CELL_POSITION_X = 35
