# 摘要：奥术法师专精定义，迁移自 PhantomProject 上游 lua 并按本地容器约定重写。

# 描述：
# 同步上游 src/class/mage_arcane.lua 的 SpellList、PartyBuff 字段。表 key 统一为整数 1..n。
...
# party_buff：奥术智慧单对象，spellIDs 含玩家自身与施加他人两 Aura ID。
