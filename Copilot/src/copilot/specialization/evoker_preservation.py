# 摘要：恩护唤魔师专精定义，迁移自 PhantomProject 上游 lua 并按本地容器约定重写。

# 描述：
# 同步上游 src/class/evoker_preservation.lua 的 SpellList、PartyBuff 字段。表 key 统一为整数 1..n。
...
# spell_list：仅 index 1 为公共冷却，上游其余技能未定义。
# party_buff：青铜祝福单对象。
