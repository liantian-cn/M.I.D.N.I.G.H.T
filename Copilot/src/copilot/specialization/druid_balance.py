# 摘要：平衡德鲁伊专精定义，迁移自 PhantomProject 上游 lua 并按本地容器约定重写。

# 描述：
# 同步上游 src/class/druid_balance.lua 的 SpellList、PartyBuff 字段。表 key 统一为整数 1..n。
