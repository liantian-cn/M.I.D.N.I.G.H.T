# 摘要：狂徒潜行者专精定义，迁移自 PhantomProject 上游 lua 并按本地容器约定重写。

# 描述：
# 同步上游 src/class/rogue_outlaw.lua 的 SpellList、ChargeList 字段。表 key 统一为整数 1..n。
...
# spell_list：23 项；index 22 抓钩具备 charge。
# charge_list：抓钩 maxValue=8（上游为 Phantom 0..8 fallback）。
...
class RogueOutlaw(SpecTemplate):
    ...
    def __init__(self):
        ...
        self.spell_list = {  # 等效lua的addonTable.SPEC.SpellList
            ...
            22: {"spellId": 195475, "description": "抓钩", "charge": True},
