...
insert(cooldownSpells, { spellID = 1245412, name = "虚空之刃" }) --  [虚空之刃]
insert(cooldownSpells, { spellID = 1239123, name = "饥渴斩击" }) --  [饥渴斩击]
insert(cooldownSpells, { spellID = 198793, name = "复仇回避" }) --  [复仇回避]

insert(chargeSpells, { spellID = 1241937, name = "灵魂献祭" }) --  [灵魂献祭]
insert(chargeSpells, { spellID = 1225826, name = "根除" }) --  [根除]
