...
- Stay on lowercase `my-feature`, following the repo root `AGENTS.md`.
...
- **REQUIRED REPO SKILL:** Also load the `adding-rotation-config` skill once the input is complete.
- Use it to lock:
